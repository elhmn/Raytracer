...
/*   Updated: 2016/10/01 11:12:50 by bmbarga          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//		put_camera(*(rt[0]->camera)); //Debug
		...
		pos_add_to_pos(&(rt[0]->camera->sp.o), get_pos(0, 400, -2000)); //Debug
//		pos_add_to_pos(&(rt[0]->camera->sp.o), get_pos(0, 1000, -5000)); //Debug
	}
